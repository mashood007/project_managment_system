...
<input type="hidden" id="base_url" value="<?php echo base_url("/marketing/rate_lead");?>">
           <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-4">
                      ...
                      <button class="btn btn-success btn-block mb-2" onclick="showSwal('success-message')">Convert as customer <i class="mdi mdi-account-multiple-plus"></i></button>
                      <button class="btn btn-warning btn-block mb-2">Edit Data <i class="mdi mdi-pen"></i></button><br>
                    </div>
                    <div class="col-lg-8">
                          ...
                          <div class="ml-4">
                            <h6>
                              ...
                              <small class="ml-4 text-muted">
                                ...
                                <i class="mdi mdi-whatsapp"></i> <?php echo $follow['route'];?>
                              </span>&nbsp;&nbsp;&nbsp;
