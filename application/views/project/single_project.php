                    ...
                    <div class="col-lg-4">
                      <div class="border-bottom text-center pb-4">
                        ...
                        <br>
                         <div class="row">
                          <div class="col-sm-6">                         
                          <button class="btn btn-dark btn-block mr-2 btn-icon-text" onclick="window.location.href ='<?php echo base_url('projects/status/index/'.$project['id']); ?>'">
                            <i class="mdi mdi-flag-checkered btn-icon-prepend"></i>Status</button>
                          </div>
                          <div class="col-sm-6">
