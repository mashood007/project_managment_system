          ...
          <button onclick="window.location.href='<?php echo base_url('project/job_todo/'.$project['id'].'/'.$row['todo_id']);?>'" type="button" class="todo-button btn btn<?php if($todo_id != $row['todo_id']) {echo '-outline';} ?>-primary btn-rounded btn-fw"><?php echo $row['todo_name'];?>&nbsp;&nbsp;
...
<script type="text/javascript">
  todo_tasks("<?php echo base_url('project/job_todo_tasks/'.$todo_id); ?>")
</script>