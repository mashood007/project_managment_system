           <div class="row">
            <div class="col-12">
                    ...
                    <div class="col-lg-8">
                      ...
                      <div class="mt-4 py-2 border-top border-bottom">
                        <ul class="nav profile-navbar">
                          ...
                          <li class="nav-item">
                            <a class="nav-link " href="meterial-usage.html">
                              <i class="ti-hummer"></i>
                              Usage
                            </a>
                          </li>
                          <li class="nav-item">
                            <a class="nav-link active" href="meterial-return.html">
                              <i class="ti-car"></i>
                              Return 
                            </a>
                          </li>
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="display-4">Meterial Return Status</h4>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                         <?php if ($project['mr_status'] > 0)
                          {?>
                          <td><label class="badge badge-success badge-pill">Done</label></td>
                          <?php }
                          else { ?>
                          <td><label class="badge badge-danger badge-pill">Pending</label></td>
                        <?php } ?>
                          <td><?php echo $project['mr_returned_on']; ?></td>
                          <td><?php echo $project['mr_by_name']; ?></td>
                        </tr>
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="display-2">Return Meterials</h4>
                    <p class="card-description">
                    ...
                    <table class="table">
                      ...
                      foreach ($items as $row) {
                        ...
                        <!-- Start Follow modal-->
                           ...
                           <button onclick="update_meterial_qty('<?php echo base_url("projects/meterial_return/update_qty/");?>', '<?php echo $row['id'];?>')" class="btn btn-success">Save Changes</button>
                   ...
                   <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                         <?php echo form_open("projects/meterial_return/update/".$project['id'], array('id' => 'meterial_usage_form')) ?>
                           <div class="form-group">
                            <label for="exampleTextarea1">About Return</label>
                            <textarea name="about_mr" class="form-control" id="exampleTextarea1" rows="4"><?php echo $project['about_mr']; ?></textarea>
                          </div>
                           <?php echo form_close() ?>
                        </div>
                      </div>
