           <div class="row">
            <div class="col-12">
                    ...
                    <div class="col-lg-8">
                      ...
                      <div class="mt-4 py-2 border-top border-bottom">
                        <ul class="nav profile-navbar">
                          ...
                          <li class="nav-item">
                            <a class="nav-link active" href="<?php echo base_url("projects/meterial_return/index/".$project['id']);?>">
                              <i class="ti-car"></i>
                              Return 
                            </a>
                          </li>
              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="display-4">Meterial Returns</h4>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
                        $slno =0;
                        foreach ($meterial_returns as $row) {
                          $slno += 1;
                          ?>
                          <tr>
                            <td><?php echo $slno; ?></td>
                ...
                <button onclick="window.location.href = '<?php echo base_url("projects/meterial_return/add/".$project['id']);?>'" class="btn btn-primary mr-2"><i class="ti-car"></i> Create a Meterial Return</button>
