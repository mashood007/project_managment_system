 <input type="hidden" id="units_url" value="<?php echo base_url("invoice/sales/item_units"); ?>">
          ...
          <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="display-2">Meterials</h4>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-3">
                            <button type="button" onclick="add_mu_item('<?php echo base_url("projects/meterial_return/add_item/".$project['id']);?>')" class="btn btn-primary btn-icon-text">
                                ADD
                              </button>
                          </div>
                        </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <a class="btn btn-light" onclick="window.location.href='<?php echo base_url("projects/meterial_return/index/".$project["id"]); ?>'">
                      <i class="ti-angle-left"></i> Back</a>
                    <button onclick="window.location.href = '<?php echo base_url("projects/meterial_return/create_mr/".$project['id']);?>'" class="btn btn-outline-primary mr-2"><i class="ti-car"></i> Create Meterial Return</button>
