              ...
              <button class="btn btn-outline-primary" onclick="edit_cart('<?php echo $row['id'];?>')">
                        ...
                        <!-- Start Follow modal-->
                           ...
                           <button onclick="update_cart('<?php echo base_url("/invoice/purchase_order/update_cart/");?>', '<?php echo $row['id'];?>')" class="btn btn-success">Save Changes</button>
                        ...
                        <!-- End Follow modal-->
                                  ...
                                  <td>
<span class="btn btn-outline-danger" onclick="delete_purchase_item('<?php echo base_url("invoice/purchase_order/delete_temp/".$row['id']);?>','<?php echo $row["id"]; ?>')"><i class="ti-trash"></i></span></td>
