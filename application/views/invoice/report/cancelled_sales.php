                ...
                <div class="col-12 col-xl-12">
                  <div class="d-flex align-items-center justify-content-between flex-wrap">
                    <div class="border-right pr-4 mb-3 mb-xl-0">
                      ...
                      <h4 class="mb-0 font-weight-bold"><font size="4">₹<span id="total_sale"></span></font><br><font color="DodgerBlue" size="2"><span id="total_invoices"></span>&nbsp;Cancelled</font></h4>
                    </div>
                    
                    <div class="border-right pr-4 mb-3 mb-xl-0">
                      <p class="text-muted"><i class="mdi mdi-cart-outline"></i> This Year Cancelled</p>
                      <h4 class="mb-0 font-weight-bold"><font size="4">₹<span id="year_sale"></span></font><br><font color="green" size="2"><span id="year_invoice"></span>&nbsp;Cancelled</font></h4>
                    </div>
                   
                    <div class="border-right pr-3 mb-3 mb-xl-0">
                      <p class="text-muted"><i class="mdi mdi-cart-plus"></i> This Month Cancelled</p>
                      <h4 class="mb-0 font-weight-bold"><font size="4">₹<span id="month_sale"></span></font><br><font color="orange" size="2"><span id="month_invoice"></span>&nbsp;Cancelled</font></h4>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            ...
                            <input id="from_date" onchange="filter('<?php echo base_url("invoice/report/filter_cancelled_invoices");?>')" type="text" class="form-control" placeholder="dd/mm/yyyy">
                     ...
                     <div class="col-md-3">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            ...
                            <input id="to_date" onchange="filter('<?php echo base_url("invoice/report/filter_cancelled_invoices");?>')" type="text" class="form-control" placeholder="dd/mm/yyyy">
                             <span class="input-group-addon input-group-append border-left">
                             <span class="ti-calendar input-group-text"></span>
                             </span>
                           </div>
          ...
          <div class="card">
            <div class="card-body">
              <h4 class="display-4">Cancelled Invoices</h4>
              <div class="row">
                <div class="col-12">
