     ...
     <input type="hidden" id="customer_id" value="<?php echo $invoice['customer_id'];?>">
          ...
          <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="display-2">Credit Note&nbsp;#01</h4><h6 class="display-4">Invoice&nbsp;#<?php echo $invoice["id"]; ?></h6>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                           <div class="form-group">
                            ...
                            <textarea id="about" class="form-control" id="exampleTextarea1" rows="4"></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
