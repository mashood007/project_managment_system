 ...
 <input type="hidden" id="temp_party_url" value="<?php echo base_url("temp_party/add"); ?>">
          ...
          <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="display-2">Last Purchase Invoice&nbsp;#<?php echo $last_invoice_no;?></h4>
                      ...
                      <div class="col-md-12">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-4">
                            ...
                            <input type="text" value="<?php echo date('m/d/Y'); ?>" name="purchase_date" id="purchase_date" class="form-control" placeholder="mm/dd/yyyy">
                    ...
                    <div class="row">
                     ...
                     <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-3">
                            <button type="button" onclick="add_purchase_item('<?php echo base_url("invoice/purchase/add_item");?>')" class="btn btn-primary btn-icon-text">
                                ADD
                              </button>
                          </div>
                        </div>
                  ...
                  <div class="table-responsive">
                   ...
                   <div class="row">
                      <div class="col-md-12">
                       ...
                       <?php echo form_open_multipart("invoice/purchase/add", array('id' => 'purchase_invoice_form')) ?>
                      </div>
                    </div>
                  </div>
                       ...
                       <div class="col-md-6">
                        <div class="form-group row">
                          <div class="col-sm-12" id="balance_will_be">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                         Balance will be: <font color="green" size="5" class="display-4"> ₹0.00</font> <font color="grey" size="1">is advanced</font><br>
                          </div>
                        </div>
                      </div>
                    </div>
...
<script type="text/javascript">
  ...
  cart('<?php echo base_url("invoice/purchase/cart");?>')
</script>