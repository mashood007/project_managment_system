                      ...
                      <div class="col-md-12">
                        <div class="form-group row">
                          <div class="col-sm-2">
                            <div class="form-check">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input sale_type" name="sale_type" id="sale_type" value="0" checked>
                                Local Sale
                              </label>
                            </div>
                          </div>
                          <div class="col-sm-2">
                            <div class="form-check">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input sale_type" name="sale_type" id="membershipRadios2" value="1">
                                Interstate Sale
                              </label>
                            </div>
                          </div>
                        ...
                        <div class="form-group row">
                          <div class="col-sm-12">
                            <select class="js-example-basic-single w-100" id="item_list">
                              ...
                              {
                                ?>
                              <option data-discound = "<?php echo $row['discound'];?>" data-type="service" data-price="<?php echo $row['price'];?>" value="<?php echo $row['id'];?>"><?php echo $row['service'];?></option>
                            <?php } ?>
                              ...
                              {
                                ?>
                              <option data-discound = "<?php echo $row['discound'];?>" data-type="product" data-price="<?php echo $row['sales_price'];?>" value="<?php echo $row['id'];?>"><?php echo $row['product_name'];?></option>
                            <?php } ?>
