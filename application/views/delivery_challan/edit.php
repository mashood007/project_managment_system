...
<input type="hidden" name="edit_invoice_no" id="edit_invoice_no" value="<?php echo 
$delivery_challan->id;?>">
                     <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          <div class="col-sm-3">
                            <div class="form-check">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="for_type" id="for_type" value="indivitual" <?php if ($delivery_challan->for_type == 'indivitual'){echo 'checked';}?> >
                                For Indivitual
                              </label>
                            </div>
                          </div>
                          <div class="col-sm-3">
                            <div class="form-check">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="for_type" id="for_type" value="project" <?php if ($delivery_challan->for_type == 'project'){echo 'checked';}?> >
                          ...
                          <div class="col-sm-3">
                            <div class="form-check">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="for_type" id="for_type" value="branch" <?php if ($delivery_challan->for_type == 'branch'){echo 'checked';}?>>
          ...
          <div class="col-12 grid-margin">
              ...
              <?php echo form_open("delivery_challan/update/".$delivery_challan->id, array('id' => 'delivery_challan_form')) ?>
              <input type="hidden" name="for_cat" value="<?php echo $delivery_challan->for_cat; ?>" id="for_cat">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group row">
                          <div class="col-sm-3">
                            <div class="form-check">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="bound" id="outbound" value="outbound" <?php if ($delivery_challan->bound == 'outbound'){echo 'checked';}?> >
                                Outbound
                              </label>
                            </div>
                          </div>
                          <div class="col-sm-3">
                            <div class="form-check">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="bound" id="inbound" value="inbound" <?php if ($delivery_challan->bound == 'inbound'){echo 'checked';}?> >
                                Inbound
                              </label>
                            </div>
                          </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            ...
                            <input type="text" value="<?php echo $delivery_challan->delivery_date; ?>" class="form-control" name="delivery_date" placeholder="mm/dd/yyyy">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="location" id="location" required class="form-control" value="<?php echo $delivery_challan->location; ?>" placeholder="Delivery Location" />
                          </div>
                        </div>
                      </div>
                     <div class="col-md-6">
                        <div class="form-group row">
                         <label class="col-sm-3 col-form-label">Reason <font color="red">*</font></label>
                          <div class="col-sm-9">
                            <input type="text" name="reason" id="reason" required class="form-control" value="<?php echo $delivery_challan->reason; ?>" placeholder="Reason for this move" />
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                     ...
                     <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-3">
                            <button type="button" onclick="add_purchase_item('<?php echo base_url("delivery_challan_dep/cart/add/".$delivery_challan->id);?>')" class="btn btn-primary btn-icon-text">
                                ADD
                              </button>
                          </div>
                        </div>
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                   ...
                   <div class="row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-6">
                           <div class="form-group">
                            ...
                            <textarea name="about" id="about" class="form-control" id="exampleTextarea1" rows="4"><?php echo $delivery_challan->about; ?></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <span type="button" onclick="delivery_challan_form_submit()" class="btn btn-success mr-2"><i class="ti-save"></i> Update</span>
...
<script type="text/javascript">
  ...
  cart('<?php echo base_url("delivery_challan/dc_cart/".$delivery_challan->id);?>')
  delivery_for_list_with_selected('<?php echo $delivery_challan->for_type; ?>', "<?php echo $delivery_challan->delivery_for; ?>")
</script>